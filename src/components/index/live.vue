		...
		<div class="group">
			...
			<div class="personal_data">
				<ul>
					...
					<li class="list clearfix">
						<span class="name fl">直播间名称</span>
						<router-link to="/livename">
							<div class="fr">
								<span class="list_title">民族歌曲</span>
								<i class="iconfont icon-youkuohao"></i>
							</div>
						</router-link>
					</li>
					<li class="list clearfix">
						<span class="name fl">直播场所</span>
					...
					<li class="list clearfix">
						<span class="name fl">设置直播间活动</span>
